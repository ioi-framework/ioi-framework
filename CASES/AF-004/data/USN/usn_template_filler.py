...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python3 usn_template_filler.py <input.json|csv> <output.jsonld>")
        print("  Supports: JSON, JSONL, or CSV (MFTECmd output)")
        sys.exit(1)
    ...
    fill_template_from_data(input_file, output_file)
